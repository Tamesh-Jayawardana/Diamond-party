...
class Road_Sale_Products_Widget extends \Elementor\Widget_Base { 
	...
	protected function render() {
		...
		if($settings['responsive'] == 'default') {
			$responsive = rozer_default_responsive((int)$settings['items']);
		}else{
			$default_responsive = rozer_default_responsive((int)$settings['items']);
			$responsive = array(
								...
								<div class="product-inner">
									...
									<div class="product-content">
										...
										<?php 
											...
											<?php endif;
											if($show_stock) {
												echo rozer_product_stock($product); 
											}
							...
							<div class="design-2">
								<div class="product-inner">
									<div class="product-image">
										...
										<?php endif; ?>
										<?php  rozer_product_onsale_countdown(); ?>
									</div>
									<div class="product-content">
										<?php if($show_category): ?>
										<div class="product-category">
